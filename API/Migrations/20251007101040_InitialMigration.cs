        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Coupon_Name = table.Column<string>(type: "text", nullable: true),
                    Coupon_AmountOff = table.Column<long>(type: "bigint", nullable: true),
                    Coupon_PercentOff = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
                    Coupon_PromotionCode = table.Column<string>(type: "text", nullable: true),
                    Coupon_CouponId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "26572ddd-b858-4a7a-a862-9de6256e6cb7", null, "Admin", "ADMIN" },
                    { "99fef3c2-3c12-4696-9e7f-b93e5c27a0e4", null, "Member", "MEMBER" }
                });
